...
function appendVoiceRow(form, voiceType) {
  ...
  labelInput.className = "voice-label";
  labelInput.type = "text";
  labelInput.name = `${voiceType}Label`;
  ...
  valueInput.name = voiceType;
  valueInput.min = min;
  valueInput.step = step;
  valueInput.value = "0";
  inputWrap.append(prefix, valueInput);
  row.append(labelInput, inputWrap);
